...
const Home = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const { data } = await axiosPublic.get(
        `/products?page=${currentPage}&limit=${limit}&name=${searchQuery}&category=${selectedCategory}&minPrice=${minPrice}&maxPrice=${maxPrice}&sortBy=${sortBy}`
      );
  ...
  return (
    <div className="container mx-auto px-4 pt-28">
      ...
      <div className="mb-8">
        <form onSubmit={handleSearch} className="lg:flex lg:space-x-4 lg:mb-4">
          {/* Search Bar */}
          <input
            type="text"
